...
class Crypto {
 ...
 public:
  ...
  static void HKEY_MD5(const char *password, unsigned char *key,
                       unsigned int key_size);
  static void HKDF_SHA1(const unsigned char *salt, int salt_len,
...
class CryptoCreator {
 public:
  ...
  static CryptoCreator *NewInstance(const char *algorithm,
                                    const char *password);
